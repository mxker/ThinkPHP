...
<div class="main-div">
    ...
    <form method="post" action="<?php echo U();?>">
        <table cellspacing="1" cellpadding="3" width="100%">
                ...
                <td>
                    <input type="radio" value="1" name="is_help" class="is_help"/> 是
                    <input type="radio" value="0" name="is_help" class="is_help"/> 否                    <span class="require-field">*</span>
                </td>
            </tr>
                        <tr>
...
<script type="text/javascript">
    ...
    <script type="text/javascript">
        $(function(){
            $('.is_help').val([<?php echo ((isset($is_help ) && ($is_help !== ""))?($is_help ):1); ?>]);//是否是帮助,设置默认值
        })
    </script>
